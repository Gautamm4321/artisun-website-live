...
export default function WornSection() {
  return (
    ...
    >
      ...
      >
        {/* Main Headline */}
        <h2 className="font-editorial text-[var(--brand-cream,#f5f0eb)] text-[31px] xs:text-[35px] sm:text-[43px] md:text-[46px] lg:text-[42px] xl:text-[46px] leading-[1.32] lg:leading-[1.04] tracking-tight font-normal drop-shadow-md w-full max-w-[320px] xs:max-w-[350px] sm:max-w-[560px] lg:max-w-[580px] xl:max-w-[640px]">
