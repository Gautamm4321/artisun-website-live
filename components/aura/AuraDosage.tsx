...
// usePanelEdgeScroll removed
  ...
  return (
    ...
    >
      {/* Top Heading */}
      <div className="relative z-10 max-w-[1500px] w-full mx-auto pt-0 md:pt-2 lg:pt-10">
        <div className="w-full max-w-[540px] md:max-w-[660px]">
          <span className="font-suisse text-[10px] sm:text-xs md:text-[13px] tracking-[0.2em] uppercase text-[var(--brand-cream)]/70">
            How to wear
          </span>
          <h2 className="font-editorial text-[26px] sm:text-[40px] md:text-[46px] lg:text-[52px] leading-[1.08] tracking-tight mt-1 text-[#E8DCC8]">
            The first sunscreen that changes with the weather.
          </h2>
          <p className="font-suisse text-[11.5px] sm:text-[13.5px] md:text-[14.5px] text-[var(--brand-cream)]/80 mt-1.5 md:mt-2 leading-[1.45]">
      ...
      <div className="relative z-10 max-w-[1500px] w-full mx-auto my-2 md:my-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 lg:gap-14 items-center pt-2 md:pt-2">
        
        {/* Left: Image Card (Sharp Corners) */}
        <div className="relative w-full h-[220px] sm:h-[260px] md:h-[560px] md:min-h-[560px] md:max-h-[600px] lg:h-full min-h-0 overflow-hidden shadow-2xl bg-black/20 flex items-center justify-center transition-all duration-500">
          <Image
            key={current.image}
          ...
          <div className="absolute bottom-3 left-3 right-3 md:bottom-5 md:left-5 md:right-5 bg-black/60 backdrop-blur-md p-4 md:p-5 border border-white/10 z-20">
            <span className="font-editorial text-[#E8DCC8] text-base sm:text-lg md:text-2xl block font-semibold">
              {current.weather}
            </span>
            <span className="font-suisse text-[11px] sm:text-xs md:text-[14px] text-[var(--brand-cream)]/85 block mt-0.5 md:mt-1 leading-snug">
              {current.desc}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center space-y-3 md:space-y-6 w-full max-w-[520px] md:max-w-[540px] mx-auto md:mx-0">
          <p className="font-suisse text-xs md:text-[14px] uppercase tracking-[0.18em] md:tracking-[0.22em] opacity-75">
            Select Amount:
          </p>
          ...
          {/* Bottom Lines */}
          <div className="pt-3 md:pt-6 border-t border-white/15 space-y-1 md:space-y-2">
            <p className="font-editorial text-base sm:text-lg md:text-[22px] non-italic text-[var(--brand-cream)]/90">
              One sunscreen. Every season. Never the wrong amount.
            </p>
            <p className="font-suisse text-[11px] sm:text-xs md:text-[14px] text-[var(--brand-cream)]/60">
